...
public sealed class MergeRecursiveSortAsyncTests
{
    ...
    {
        await Assert.ThrowsAsync<ArgumentNullException>(() => Sorting.MergeSortAsync.RecursiveSortAsync(null));
    }
}
