...
public sealed class MergeRecursiveSortTests
{
    ...
    {
        Assert.Throws<ArgumentNullException>(() => Sorting.MergeSort.RecursiveSort(null));
    }
}
